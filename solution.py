...
def analyse(capture,nodes,out_video,seconds_in_queue):
    ...
    while True:
        ...
        print("Queue:",counter_in,". Delayed:",counter_in_delayed,". Others:",counter_out,".")
        print("Current time from video start:",current_time)
        cv2.putText(image,str(counter_in)+":"+str(counter_in_delayed),(50, 50),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,255),2,cv2.LINE_AA)
...
# Perform analysis
nodes=analyse(capture,nodes,out_video,seconds_in_queue)
